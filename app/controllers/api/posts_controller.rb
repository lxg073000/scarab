class Api::PostsController < ApplicationController
  ...
  def postParams
    params.require(:post).permit(:username, :comment_id, :google_route_id, :activity_id, :user_id, :title, :body, :pace, :distance, :travelMode, :created_at, :duration => [], :like_id => [], :comment_id => [])
  end
end
