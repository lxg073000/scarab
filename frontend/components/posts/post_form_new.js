        ...
        <div className="new-post-shell">
          ...
          <div className="heading-left">
            ...
            <div className="heading-right">
              <p className="button-white" onClick={()=>location.assign("#/dashboard")}>Discard</p>
              <p className="button-orange" onClick={()=>this.submitPost()}>Publish</p>
            </div>
          </section>
          <section className="post-input">
            <input type="text" id="new-post-title-val" className="text" placeholder="Add a title (optional)"/>
            <textarea id="new-post-body-val" className="textarea" placeholder="What's going on?"/>
          </section>
