...
class post_form_edit extends Component {
  constructor(props) {
    super(props);
    this.state = {
      id: "",
  ...
  componentDidUpdate(prevProps) {
    if (prevProps !== this.props) {
      this.setState({
        ...this.props.posts[this.props.match.params.post_id],
      });
    }
  }
  ...
  updateBuggout() {
    ...
    this.props.updateBuggout(post);
    this.setState({}, location.assign("#/posts/"));
  }
